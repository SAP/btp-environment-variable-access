[![Maven Central](https://img.shields.io/badge/Maven_Central-0.2.0-yellow.svg)](https://search.maven.org/search?q=g:com.sap.cloud.environment.servicebinding%2BAND%2Ba:java-bom)
