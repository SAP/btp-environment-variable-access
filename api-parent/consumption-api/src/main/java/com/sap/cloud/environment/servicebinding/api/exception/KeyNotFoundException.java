...
public class KeyNotFoundException extends RuntimeException
{
    ...
    /**
     * Initializes a new {@link KeyNotFoundException} instance with a given {@code typedMapView} and {@code requestedKey}.
     *
     * @param typedMapView The {@link TypedMapView} that was queries.
     * @param requestedKey The key that wasn't found.
     */
