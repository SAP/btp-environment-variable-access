...
class DataParsingStrategyTest
{
    ...
    void parseValidBinding() throws IOException
    {
        ...
        assertThat(serviceBinding.getKeys()).containsExactlyInAnyOrder("instance_guid", "instance_name", "label", "plan", "tags", "credentials");
        ...
        assertThat((List<Object>) serviceBinding.getCredentials().get("domains")).containsExactly("my-domain-1", "my-domain-2");
